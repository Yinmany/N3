...
namespace ProjectX
{
    ...
    [ProtoContract]
    public partial class A2W_Server_AddReq : IRequest
    {
        public const int _MsgId_ = (int)ProjectX.InnerMsgId.A2W_Server_AddReq;
    ...
    [ProtoContract]
    public partial class A2W_Server_AddRsp : IResponse
    {
        public const int _MsgId_ = (int)ProjectX.InnerMsgId.A2W_Server_AddRsp;
        public int MsgId => _MsgId_;
        [ProtoMember(1)] public int RpcId { get; set; }
    ...
    [ProtoContract]
    public partial class W2A_Server_AddMsg : IMessage
    {
        public const int _MsgId_ = (int)ProjectX.InnerMsgId.W2A_Server_AddMsg;
        public int MsgId => _MsgId_;
